            ...
            <main className="flex-1 bg-white">
                ...
                <section className="w-full bg-white lg:py-10 py-5">
                    <div className="lg:px-10 xl:px-16 px-5">
                        ...
                        >
                            About <span className="text-[#F68D13]">Winz Infotech</span>
                        </motion.h2>
                        ...
                        >
                            ...
                            We're not your typical agency. We're the team that turns brands into revenue machines,
                            strategies into sales, and creative ideas into measurable growth. From brand identity
                            to high-converting campaigns, everything we do is built to move your business forward, faster.
                        </motion.p>
                    </div>
                </section>
                ...
                <div className="relative">
                    <div className="w-full h-[350px] sm:h-[450px] md:h-[630px] lg:h-[680px] overflow-hidden">
                        <img
                            src={workImage}
                            alt="Work"
                            className="w-full h-full object-cover p-4 sm:p-6 md:p-10 xl:p-16"
                        />
                    </div>
                </div>
