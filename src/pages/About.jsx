    ...
    <div className="bg-white text-black overflow-x-hidden flex flex-col min-h-screen w-full mt-20 lg:pt-10 pt-5">
      ...
      <main className="flex-1 bg-white">
        ...
        <div className="relative">
          ...
          {/* Who We Are */}
          <div className="relative z-10 mt-[300px] sm:mt-[400px] md:mt-[530px] p-4 sm:p-6 md:p-10 bg-white/80 backdrop-blur-sm">
            ...
            <p>
                ...
                <span className="text-black font-medium">build brand</span>{" "}
                visibility, create{" "}
                <span className="text-black font-medium">scroll-stopping content</span>{" "}
                and turn your digital presence into a{" "}
                <span className="text-black font-medium">sales machine.</span>
            </p>
            <p>
                Our team blends sharp strategy with stunning design to give you
                what matters: More leads. Better clients. Real results.{" "}
                <span className="text-black font-medium">speed, clarity, and results</span>{" "}
            ...
            <p>
                ...
                <span className="text-black font-medium">fast, smart,</span> and{" "}
                <span className="text-black font-medium">beautifully.</span>
            </p>
            <p>
                If you're tired of "
                <span className="text-black font-medium">So-called experts</span>"
          ...
          <div className="relative z-10 bg-white">
            <div className="flex flex-col py-12 bg-gray-50">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-start px-4 sm:px-6 md:px-10">
            ...
            {/* Vision */}
            <div className="px-4 sm:px-6 md:px-10 py-20">
              <h2 className="xl:text-6xl lg:text-5xl md:text-4xl text-3xl font-medium mb-3 px-2 sm:px-6 md:px-12">
            ...
            {/* Mission */}
            <div className="bg-gray-50 px-6 sm:px-10 md:px-20 pt-10 py-20 overflow-hidden">
